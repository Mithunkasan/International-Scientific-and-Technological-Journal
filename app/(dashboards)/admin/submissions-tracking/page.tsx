...
export default async function SubmissionsTrackingPage() {
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1 font-medium">
          Real-time metrics, review bottlenecks, and status tracking for all papers.
        </p>
      </div>
      ...
      <Card className="border-border shadow-xs overflow-hidden">
        <CardHeader className="bg-card px-6 py-4 border-b border-border">
          <CardTitle className="text-base font-bold text-foreground tracking-tight uppercase flex items-center gap-2">
            ...
            <span>Manuscript Review Timelines ({papers.length})</span>
          </CardTitle>
        </CardHeader>
              ...
              <table className="w-full text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-secondary/40 border-b border-border">
                    ...
                    <th className="p-4 font-bold text-primary text-sm uppercase tracking-wider">Last Status Update</th>
                    <th className="p-4 font-bold text-primary text-sm uppercase tracking-wider">Current Status</th>
                  </tr>
                </thead>
